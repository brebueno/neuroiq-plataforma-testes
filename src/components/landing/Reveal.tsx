...
// Conta de 0 até `end` com easing, ao entrar na viewport. Respeita reduced-motion.
export function CountUp({ end, duration = 1400, className = '' }: { end: number; duration?: number; className?: string }) {
  ...
  return <span ref={ref} className={className}>{val.toLocaleString('pt-BR')}</span>;
}
